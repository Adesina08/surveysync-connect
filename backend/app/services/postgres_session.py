...
class PgSession:
    ...
    creds: Optional[postgres_service.PostgresCredentials] = None


_PG_SESSION = PgSession()


def set_credentials(creds: postgres_service.PostgresCredentials) -> None:
...
def get_credentials() -> postgres_service.PostgresCredentials:
